-- DropForeignKey
ALTER TABLE `review` DROP FOREIGN KEY `Review_customerProfileId_fkey`;
...
-- AlterTable
ALTER TABLE `review` ADD COLUMN `isMock` BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE `Review` ADD CONSTRAINT `Review_orderItemId_fkey` FOREIGN KEY (`orderItemId`) REFERENCES `order_items`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
